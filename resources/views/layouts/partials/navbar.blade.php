...
<div class="nav-header">
    <div class="brand-logo">
        <a href="{{ route('dashboard') }}">
            ...
            <span style="font-weight: bold; font-size: 15px; color: #fff">SIMPELDIK</span>
            </span>
        </a>
    </div>
</div>
...
<div class="header">
    ...
    $user = null;
    $userName = 'User';
    // $photoPath = 'images/user/foto_guru/fYey0LSswU2BiLMyUEIUhM0a4yObFrx3jDiWXwVh.png';
...
if (Auth::guard('guru')->check()) {
    ...
    if ($user->foto) {
        $photoPath = 'storage/' . $user->foto;  // ← ini penting
    }
            ...
            <div class="drop-down dropdown-profile animated fadeIn dropdown-menu">
                <div class="dropdown-content-body">
                    <div class="d-flex align-items-center p-3 border-bottom">
                        <img src="{{ asset($photoPath) }}" height="50" width="50" class="rounded-circle mr-3" alt="User">
                        <div>
