    ...
    <div class="row">
            ...
            <div class="card gradient-1">
                <div class="card-body">
                    ...
                    <div class="d-inline-block">
                        ...
                        <p class="text-white mb-0">2024/2025</p>
                    </div>
            ...
            <div class="card gradient-2">
                <div class="card-body">
                    ...
                    <div class="d-inline-block">
                        ...
                        <p class="text-white mb-0">A1-B3</p>
                    </div>
        ...
        <div class="col-lg-3 col-sm-6">
            <div class="card gradient-4">
                <div class="card-body">
                    <h3 class="card-title text-white">Data Orangtua</h3>
                    <div class="d-inline-block">
                        <h2 class="text-white">50</h2>
                        <p class="text-white mb-0">A1-B3</p>
                    </div>
                    <span class="float-right display-5 opacity-5"><i class="fas fa-id-card"></i></span>
                </div>
            </div>
        </div>
    </div>
